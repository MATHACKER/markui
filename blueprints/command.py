...
async def invite(message:Message):
    if message.action.member_id == -212164379:
        await message.answer('💬 Привет, меня зовут Mark! 💎 Я работаю на нейронной сети INFINITY, разработанной @darksnaper . 🧩 Я, как и любая нейросеть, развиваюсь со временем, просто общайтесь и вы поможете мне сать лучше. ❗ Для того, чтобы я работал, мне нужно выдать админа в беседе.')
